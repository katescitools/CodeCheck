...
{
    // ...
    throw std::logic_error("Error"); // UndCC_Violation - both exception type and
    // error message are not unique
}
void F3()
{
    // ...
    throw std::invalid_argument("Error"); // UndCC_Valid - exception type is unique
}
void F4() noexcept(false)
{
    // ...
    throw std::logic_error("f3(): preconditions were not met"); // UndCC_Valid -
                                                                // error
                                                                // message is
                                                                // unique
}
void F5() noexcept(false)
{
    ...
    throw std::logic_error(ComposeMessage(
        ...
        __func__,
        __LINE__,
        "postconditions were not met")); // UndCC_Valid - error message is unique
}
void F6() noexcept
{
    try
